...
public class MySqlSelectVisitorUnitTest {
    ...
    public void shardkeyTestIn() {
        String sql = "select a.member_name , a.member_id , b.destination , b.start_place  FROM t_scd_order a , t_scd_order_detail b  where a.id = b.order_id and a.id in (1,2,3,4) or (a.id = 8 )";
    ...
    public void shardkeyTestInAndEqual() {
        String sql = "select a.member_name , a.member_id , b.destination , b.start_place  FROM t_scd_order a , t_scd_order_detail b , t_scd_order_finance c  where a.id = b.order_id and a.id in (1,2,3,4) and b.start_place = 'shanghai' or (a.id = 8)";
    ...
    public void testSqlHint(){
        String sql = "select /* SHARDING_SLAVE */ amember_name , member_id  FROM t_scd_order  where start_place = 'shanghai'";
